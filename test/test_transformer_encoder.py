...
batch_size, seq_length, input_dim = 3, 12345, 80

encoder = SpeechTransformerEncoder(d_model=16, d_ff=32, num_layers=3)

inputs = torch.FloatTensor(batch_size, seq_length, input_dim)
